...
function reme_links_admin() {
    ...
    $vk          = !empty($_POST['vk']) ? trim(strip_tags($_POST['vk'])) : '';
		...
		// Social links
		update_option('reme_behance', $behance);
		update_option('reme_facebook', $facebook);
		update_option('reme_github', $github);
	...
	<div class="wrap">
		...
		<form name="contactForm" method="post" action="<?php echo str_replace( '%7E', '~', $_SERVER['REQUEST_URI']); ?>">
			...
			<table class="form-table">
				<tbody>
					<tr>
						<th><label for="behance"><i class="fa fa-behance" aria-hidden="true"></i> | <?php _e('Behance', 'reach-me'); ?></label></th>
						<td>
							<input id="behance" name="behance" class="regular-text" type="text" value="<?php echo get_option('reme_behance'); ?>" />
						</td>
					</tr>
					<tr>
					...
					<tr>
						<th><label for="github"><i class="fa fa-github" aria-hidden="true"></i> | <?php _e('Github', 'reach-me'); ?></label></th>
						<td>
							<input id="github" name="github" class="regular-text" type="text" value="<?php echo get_option('reme_github'); ?>" />
						</td>
					</tr>
					<tr>
					...
					<tr>
						<th><label for="reddit"><i class="fa fa-reddit-alien" aria-hidden="true"></i> | <?php _e('Reddit', 'reach-me'); ?></label></th>
						<td>
							<input id="reddit" name="reddit" class="regular-text" type="text" value="<?php echo get_option('reme_reddit'); ?>" />
						</td>
					</tr>
					<tr>
					...
					<tr>
						<th><label for="youtube"><i class="fa fa-youtube-play" aria-hidden="true"></i> | <?php _e('YouTube', 'reach-me'); ?></label></th>
						<td>
